...
export * from './models/marketing/marketing-customer.model';
...
export * from './models/branchmanager/branch-manager-customer.model';
...
export * from './services/marketing/marketing-customer.service';
...
export * from './services/branchmanager/branch-manager-customer.service';
